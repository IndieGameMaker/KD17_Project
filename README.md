...
| :---: | ------------- | ------------------ | ------ | ------ | -------------- | ---------------------------------------------------------------------------------------- |
|   1   | 로빈슨 크루소 | Resonance of Light | VR     | 양석원 | 최성용         | [트렐로](https://trello.com/b/uNAwKnpm/resonance-of-lights)                              |
|   2   | 알리바바      | Be Honored         | VR     | 윤세원 | 김탁영, 송정현 | [Jira](https://vr17behonored.atlassian.net/jira/software/projects/KAN/boards/1/timeline) |
|   3   | 루톨프        | Ski Shooter        | VR     | 차명근 | 배효은         | [트렐로](https://trello.com/b/YBc3Z6RD/ski-shooter)                                      |
...
| 일정              | 기간                           |
| :---------------- | :----------------------------- |
| **총 개발 기간**  | 2024-12-09 ~ 2025-02-13        |
| **1차 기간**      | 2024-12-19 ~ 2025-01-09 (22일) |
| **중간 점검**     | 2025-01-10                     |
| **2차 기간**      | 2025-01-11 ~ 2025-02-07 (28일) |
| **알파 테스트**   | 2025-01-17                     |
| **베타 테스트**   | 2025-01-23                     |
| **발표 문서작성** | 2025-02-05 ~ 2025-02-10        |
| **발표 문서리뷰** | 2025-02-10 ~ 2025-02-11        |
| **발표 리허설**   | 2025-02-12                     |
| **시연 및 발표**  | 2025-02-13                     |
